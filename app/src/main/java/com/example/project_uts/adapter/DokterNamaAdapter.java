...
public class DokterNamaAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Dokter> items;

    public DokterNamaAdapter(Activity activity, List<Dokter> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView name = (TextView) convertView.findViewById(R.id.nama_dokter);
